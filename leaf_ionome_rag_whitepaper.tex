...
\begin{tikzpicture}[
    ...
    \node[block, left=0.8cm of db] (retriever) {\textbf{Hybrid RAG Retriever}\\\textit{Crop + Nutrient Filter}\\Cosine Re-ranking};
